...
// 图片路径
#define  LCProgressHUDSrcName(file) [@"LCProgressHUD.bundle" stringByAppendingPathComponent:file]
#define LCProgressHUDFrameworkSrcName(file) [@"Frameworks/LCProgressHUD.framework/LCProgressHUD.bundle" stringByAppendingPathComponent:file]
...
+ (void)showStatus:(LCProgressHUDStatus)status text:(NSString *)text {
    ...
    switch (status) {
        case LCProgressHUDStatusSuccess: {
            ...
            UIImage *sucImage = [UIImage imageWithContentsOfFile:sucPath] ? [UIImage imageWithContentsOfFile:sucPath] : [UIImage imageNamed: LCProgressHUDFrameworkSrcName(@"hud_success@2x.png")];
        ...
        case LCProgressHUDStatusError: {
            ...
            UIImage *errImage = [UIImage imageWithContentsOfFile:errPath] ? [UIImage imageWithContentsOfFile:errPath] : [UIImage imageNamed: LCProgressHUDFrameworkSrcName(@"hud_error@2x.png")];
            hud.mode = MBProgressHUDModeCustomView;
        ...
        case LCProgressHUDStatusInfo: {
            ...
            UIImage *infoImage = [UIImage imageWithContentsOfFile:infoPath] ? [UIImage imageWithContentsOfFile:infoPath] : [UIImage imageNamed: LCProgressHUDFrameworkSrcName(@"hud_info@2x.png")];
            hud.mode = MBProgressHUDModeCustomView;
